...
IUSE="acl audit caps doc dbus lua nls openmp python selinux test zstd"
...
src_prepare() {
	...
	eapply "${FILESDIR}"/4.15.1-autotools.patch
	eapply "${FILESDIR}"/4.15.1-restore-lua-5.1-compatibility.patch

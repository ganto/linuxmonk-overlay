...
PATCHES=(
	...
	"${FILESDIR}"/php-7.4.33-CVE-2023-0567-1.patch
	"${FILESDIR}"/php-7.4.33-CVE-2023-0567-2.patch
	"${FILESDIR}"/php-7.4.33-CVE-2023-0568.patch
	"${FILESDIR}"/php-7.4.33-CVE-2023-0662.patch
	"${FILESDIR}"/php-7.4.33-CVE-2023-3247.patch
	"${FILESDIR}"/php-7.4.33-CVE-2023-3823.patch
	"${FILESDIR}"/php-7.4.33-CVE-2023-3824.patch

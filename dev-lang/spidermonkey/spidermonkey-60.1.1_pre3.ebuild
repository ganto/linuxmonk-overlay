...
SRC_URI="https://ftp.mozilla.org/pub/spidermonkey/prereleases/60/pre3/mozjs-60.1.1pre3.tar.bz2 -> ${MY_P}.tar.bz2
...
src_prepare() {
	eapply "${WORKDIR}"/${PN}/0003-build-Fix-library-install-name-on-macOS.patch
	eapply "${FILESDIR}"/moz60-build-Include-configure-script-be-nicer-about-option.patch

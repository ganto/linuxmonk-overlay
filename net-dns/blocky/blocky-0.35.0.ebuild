...
EGO_SUM=(
	...
	"github.com/0xERR0R/expiration-cache v0.2.0/go.mod"
	...
	"github.com/breml/rootcerts v0.3.7/go.mod"
	"github.com/brunoga/deep v1.2.4"
	"github.com/brunoga/deep v1.2.4/go.mod"
	...
	"github.com/getkin/kin-openapi v0.144.0/go.mod"
	...
	"github.com/go-chi/chi/v5 v5.3.2/go.mod"
	...
	"github.com/jedisct1/go-dnsstamps v0.0.0-20260518121737-6579dc73e4a2/go.mod"
	...
	"github.com/knadh/koanf/parsers/yaml v0.1.0/go.mod"
	"github.com/knadh/koanf/providers/env v1.0.0"
	"github.com/knadh/koanf/providers/env v1.0.0/go.mod"
	"github.com/knadh/koanf/providers/file v1.1.2"
	"github.com/knadh/koanf/providers/file v1.1.2/go.mod"
	"github.com/knadh/koanf/providers/posflag v0.1.0"
	"github.com/knadh/koanf/providers/posflag v0.1.0/go.mod"
	"github.com/knadh/koanf/providers/structs v0.1.0"
	"github.com/knadh/koanf/providers/structs v0.1.0/go.mod"
	...
	"github.com/lufia/plan9stats v0.0.0-20260330125221-c963978e514e/go.mod"
	...
	"github.com/miekg/dns v1.1.73/go.mod"
	...
	"github.com/oapi-codegen/nullable v1.1.0/go.mod"
	"github.com/oapi-codegen/oapi-codegen/v2 v2.7.1"
	"github.com/oapi-codegen/oapi-codegen/v2 v2.7.1/go.mod"
	"github.com/oapi-codegen/runtime v1.7.0"
	"github.com/oapi-codegen/runtime v1.7.0/go.mod"
	"github.com/oasdiff/yaml v0.1.1"
	"github.com/oasdiff/yaml v0.1.1/go.mod"
	"github.com/oasdiff/yaml3 v0.0.14"
	"github.com/oasdiff/yaml3 v0.0.14/go.mod"
	...
	"github.com/pires/go-proxyproto v0.15.0/go.mod"
	...
	"github.com/quic-go/quic-go v0.62.0/go.mod"
	...
	"github.com/speakeasy-api/jsonpath v0.6.3/go.mod"
	"github.com/speakeasy-api/openapi v1.19.2"
	"github.com/speakeasy-api/openapi v1.19.2/go.mod"
	...
	"github.com/testcontainers/testcontainers-go/modules/mariadb v0.44.0/go.mod"
	"github.com/testcontainers/testcontainers-go/modules/postgres v0.44.0"
	"github.com/testcontainers/testcontainers-go/modules/postgres v0.44.0/go.mod"
	"github.com/testcontainers/testcontainers-go/modules/redis v0.44.0"
	"github.com/testcontainers/testcontainers-go/modules/redis v0.44.0/go.mod"
	...
	"github.com/vektra/mockery/v3 v3.6.1/go.mod"
	...
	"gorm.io/driver/postgres v1.6.2/go.mod"
	"gorm.io/driver/sqlite v1.6.0"
	"gorm.io/driver/sqlite v1.6.0/go.mod"
	"gorm.io/gorm v1.31.2"
	"gorm.io/gorm v1.31.2/go.mod"
...
src_compile() {
	...
	go build -v -o "${PN}" -ldflags="-s -w
		...
		-X github.com/0xERR0R/blocky/util.Architecture=${GOARCH}${GOARM}" || die "compile failed"
}

...
EGO_SUM=(
	...
	"github.com/abice/go-enum v0.5.5/go.mod"
	...
	"github.com/alicebob/miniredis/v2 v2.30.1/go.mod"
	...
	"github.com/avast/retry-go/v4 v4.3.3/go.mod"
	...
	"github.com/jackc/pgx/v5 v5.3.0/go.mod"
	"github.com/jackc/puddle/v2 v2.2.0/go.mod"
	...
	"github.com/mattn/goveralls v0.0.11/go.mod"
	...
	"github.com/miekg/dns v1.1.52/go.mod"
	...
	"github.com/moby/term v0.0.0-20221128092401-c43b287e0e0f/go.mod"
	...
	"github.com/mroth/weightedrand/v2 v2.0.1/go.mod"
	...
	"github.com/onsi/gomega v1.27.5/go.mod"
	...
	"github.com/swaggo/swag v1.8.11/go.mod"
	...
	"github.com/urfave/cli/v2 v2.24.1/go.mod"
	...
	"gorm.io/driver/postgres v1.5.0/go.mod"
	...
	"mvdan.cc/gofumpt v0.4.0/go.mod"

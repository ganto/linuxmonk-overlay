...
EGO_SUM=(
	...
	"github.com/DATA-DOG/go-sqlmock v1.5.1/go.mod"
	...
	"github.com/alicebob/miniredis/v2 v2.31.0/go.mod"
	...
	"github.com/deepmap/oapi-codegen v1.16.2/go.mod"
	...
	"github.com/getkin/kin-openapi v0.118.0/go.mod"
	...
	"github.com/invopop/yaml v0.1.0/go.mod"
	...
	"github.com/labstack/gommon v0.4.1/go.mod"
	...
	"github.com/oapi-codegen/runtime v1.1.0/go.mod"
	...
	"github.com/perimeterx/marshmallow v1.1.4/go.mod"
	...
	"github.com/testcontainers/testcontainers-go/modules/mariadb v0.26.0/go.mod"
	"github.com/testcontainers/testcontainers-go/modules/postgres v0.26.0"
	"github.com/testcontainers/testcontainers-go/modules/postgres v0.26.0/go.mod"
	"github.com/testcontainers/testcontainers-go/modules/redis v0.26.0"
	"github.com/testcontainers/testcontainers-go/modules/redis v0.26.0/go.mod"

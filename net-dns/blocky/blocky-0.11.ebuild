...
EGO_SUM=(
	...
	"github.com/mroth/weightedrand v0.4.0/go.mod"
	...
	"github.com/swaggo/http-swagger v0.0.0-20200308142732-58ac5e232fba/go.mod"
	"github.com/swaggo/swag v1.5.1/go.mod"
	"github.com/swaggo/swag v1.6.3/go.mod"
	"github.com/swaggo/swag v1.6.9"
	"github.com/swaggo/swag v1.6.9/go.mod"
...
src_unpack() {
	# Don't verify go.sum during unpack because it fails to find
	# blocky/docs that will be generated by swag later
	_go-module_src_unpack_verify_gosum() {
		einfo "_go-module_src_unpack_verify_gosum: skip!"
	}
...
src_prepare() {
	...
	swag init -g api/api.go || die "swag failed"
...
src_install() {
	...
	dodir /etc/blocky
	insinto /etc/blocky
	doins "${FILESDIR}"/config.yml.example

...
CRATES="
	...
	syn@1.0.109
	syn@2.0.111
	television-nucleo-matcher@0.3.1
	television-nucleo@0.5.0
	tempfile@3.23.0
	terminfo@0.9.0
	termion@4.0.6
	termios@0.3.3
...
SRC_URI="https://github.com/alexpasmantier/${PN}/archive/refs/tags/${PV}.tar.gz -> ${P}.tar.gz
	${CARGO_CRATE_URIS}"

...
CDEPEND="
	...
	>=sys-libs/libdnf-0.32.0[${PYTHON_USEDEP}]
...
PATCHES=(
	"${FILESDIR}"/4.2.5-Revert-Add-best-as-default-behavior-RhBug16707761671683.patch
	"${FILESDIR}"/${PV}-Always-use-sphinx-build.patch
)

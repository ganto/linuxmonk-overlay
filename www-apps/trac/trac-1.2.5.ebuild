...
inherit distutils-r1 eutils systemd user webapp
...
SLOT="0"
KEYWORDS="~amd64"
IUSE="fastcgi i18n +highlight +restructuredtext mysql postgres +sqlite subversion"
...
src_install() {
	...
	# tracd systemd unit
	systemd_dounit "${FILESDIR}"/tracd@.service
	systemd_newtmpfilesd "${FILESDIR}"/tracd.tmpfilesd tracd.conf

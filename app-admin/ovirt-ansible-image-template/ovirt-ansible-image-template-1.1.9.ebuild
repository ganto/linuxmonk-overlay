...
ANSIBLE_ROLE_NAME=image-template

DESCRIPTION="Ansible role to create virtual machine template from disk image"
HOMEPAGE="https://www.ovirt.org https://github.com/oVirt/ovirt-ansible-image-template"
